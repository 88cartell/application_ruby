...
action :before_migrate do
  ...
  if new_resource.bundler
    ...
    execute "#{bundle_command} install --gemfile=#{new_resource.release_path}/Gemfile --path=#{new_resource.release_path}/vendor/bundle #{bundler_deployment ? "--deployment " : ""}--without #{common_groups}" do
